...
import com.kt.std.mvvmretrofitmoviapp.model.MovieDataSource;
import com.kt.std.mvvmretrofitmoviapp.model.MovieDataSourceFactory;
...
public class MainActivityViewModel extends AndroidViewModel {
    ...
    public MainActivityViewModel(@NonNull Application application) {
        ...
        PagedList.Config config = new PagedList.Config.Builder().setEnablePlaceholders(true).setInitialLoadSizeHint(10)
                .setPageSize(20).setPrefetchDistance(3).build();
